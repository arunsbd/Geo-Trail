...
GeoTrail is a geography game which has a first playable mode called **Border Hunt — U.S. States**: guess the mystery state using the minimum number of state-border crossings as feedback.
