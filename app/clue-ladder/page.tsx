...
export const metadata = { title: 'GeoTrail — Clue Ladder', description: 'Guess a mystery U.S. state in seven clues. Play the expanding Clue Ladder practice collection.' };
